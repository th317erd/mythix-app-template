...
module.exports = {
  ...
  searchOrganizations: {
    ...
    'example': 'await API.searchOrganizations({ data: { filter: { name: \'Some Organization\', \'createdAt>=\': \'2001-01-01\', }, limit: 20, offset: 20, order: \'-Organization:name\' } });',
    'notes': [
  ...
  getOrganizations: {
    ...
    'example': 'await API.getOrganizations({ data: { limit: 20, offset: 20, order: "-Organization:name" } });',
    'notes': [
      'Only organizations you have permission to view will be returned',
