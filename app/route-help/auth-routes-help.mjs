...
module.exports = {
  login: {
    ...
    'notes': [
      ...
      'Upon success, a cookie named "<<<APP_NAME>>>-auth-token" will be set to authenticate the user',
  ...
  logout: {
    ...
    'notes': [
      'Upon success, a 200 status code will be returned, and the cookie named "<<<APP_NAME>>>-auth-token" will be set to to "null" and the "maxAge" will be set to "0", causing the cookie to be deleted.',
