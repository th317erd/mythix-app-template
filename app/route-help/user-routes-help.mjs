...
module.exports = {
  ...
  getUsers: {
    ...
    'example': 'await API.getUsers({ data: { limit: 20, offset: 20, order: "-User:firstName" } });',
    'notes': [
  ...
  searchUsers: {
    ...
    'example': 'await API.searchUsers({ data: { filter: { tags: [ \'tag1\', \'tag2\' ], roles: [ \'role1\', \'role2\' ], firstName: \'Bob\' }, limit: 20, offset: 20, order: \'-User:firstName\' } });',
    'notes': [
      'The target organization is the calling users current organization',
      'Only users you have permission to view will be returned',
